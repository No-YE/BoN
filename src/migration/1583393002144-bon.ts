...
export class bon1583393002144 implements MigrationInterface {
    name = 'bon1583393002144'
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query("CREATE TABLE `post_to_category` (`id` int NOT NULL AUTO_INCREMENT, `postId` int NOT NULL, `categoryId` int NOT NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB", undefined);
